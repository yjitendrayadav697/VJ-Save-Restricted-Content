...
ADMINS = int(os.environ.get("ADMINS", "8585795313"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://tezu2026:Ep5tdpokJdE81Md7@cluster0.gb7b7gc.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
